...
import { useFetchEncuestaTotems } from '@/actions/app/customer-experience';

export const returnUrlEncuestaTotemsPage =
  ROUTER_PATHS.customerExperience.encuestaTotemsNav;

export type EncuestaTotemsPageProps = {};

const EncuestaTotemsPage: React.FC<EncuestaTotemsPageProps> = () => {
  ...
  return (
    <SingleTableBoxScene title="Encuesta Totems">
      <CustomSearch
...
export default EncuestaTotemsPage;
