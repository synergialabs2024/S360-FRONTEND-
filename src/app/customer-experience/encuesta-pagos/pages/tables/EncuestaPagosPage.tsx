...
export type EncuestaPagosPageProps = {};

const EncuestaPagosPage: React.FC<EncuestaPagosPageProps> = () => {
  ...
  return (
    <SingleTableBoxScene title="Encuesta Pagos">
      <CustomSearch
...
export default EncuestaPagosPage;
