...
const NotificationList: React.FC<NotificationListProps> = () => {
  ...
  const chipErrorSX = {
    ...chipSX,
    color: (theme.palette as any).orange.dark,
    backgroundColor: (theme.palette as any).orange.light,
    marginRight: '5px',
  };
  ...
  const chipWarningSX = {
    ...
    backgroundColor: (theme.palette as any).warning.light,
  };
          ...
          <ListItemAvatar>
            <Avatar
              sx={{
                ...
                backgroundColor: (theme.palette as any).success.light,
                border: 'none',
                borderColor: (theme.palette as any).success.main,
              }}
            >
      ...
      <ListItemWrapper>
        <ListItem alignItems="center">
          <ListItemAvatar>
            <Avatar
              sx={{
                color: (theme.palette as any).primary.dark,
                backgroundColor: (theme.palette as any).primary.light,
                border: 'none',
                borderColor: (theme.palette as any).primary.main,
              }}
            >
          ...
          <Grid item xs={12}>
            <Grid container>
              <Grid item xs={12}>
                <Card
                  sx={{
                    backgroundColor: (theme.palette as any).secondary.light,
                  }}
                >
                  <CardContent>
