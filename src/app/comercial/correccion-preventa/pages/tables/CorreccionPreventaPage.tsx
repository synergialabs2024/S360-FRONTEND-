...
import RequiereCorreccionAgendaPreventaCustomButtons from '../../shared/components/RequiereCorreccionAgendaPreventaCustomButtons';

export type CorreccionPreventaPageProps = {};

const CorreccionPreventaPage: React.FC<CorreccionPreventaPageProps> = () => {
    ...
    <GridTableTabsContainerOnly>
      ...
      <CustomTable<Preventa>
        ...
        customButtonsSpace={preventa => {
          return (
            <>
              <RequiereCorreccionAgendaPreventaCustomButtons
                preventa={preventa!}
              />
            </>
          );
...
export default CorreccionPreventaPage;
