...
import RecepcionSolicitudDevolucionMaterialStatePage from './RecepcionSolDevolucionStatePage';

export const returnUrlRecepcionSolicitudDevolucionMaterialesPage =
  ROUTER_PATHS.inventario.recepcionSolicitudDevolucionMaterialesNav;

export type SolicitudDevolucionMaterialMainPageProps = {};

const SolicitudDevolucionMaterialMainPage: React.FC<
  SolicitudDevolucionMaterialMainPageProps
> = () => {
  const { tabValue, handleTabChange } = useTabsOnly();

  return (
    <SingleTableBoxScene
      title="Recepción de solicitudes de devolucion"
      showCreateBtn={false}
      isMainTableStates
    >
      <BoxFormTabsOnly
      ...
      <CustomTabPanel value={tabValue} index={1} ptGrid="0">
        <RecepcionSolicitudDevolucionMaterialStatePage
...
export default SolicitudDevolucionMaterialMainPage;
