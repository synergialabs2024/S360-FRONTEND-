...
import { useFetchGestionOnus, useUpdateGestionOnu } from '@/actions/app';
...
import { GestionOnu, PermissionsEnum } from '@/shared/interfaces';
...
const GestionOnusPage: React.FC<GestionOnusPageProps> = () => {
  ...
  ///* mutations
  const changeState = useUpdateGestionOnu({
  ...
  ///* handlers
  const onEdit = (gestionOnu: GestionOnu) => {
    setConfirmDialog({
      isOpen: true,
      title: 'Editar gestion de ONUs',
      subtitle: '¿Está seguro que desea editar este registro?',
      onConfirm: () => {
        setConfirmDialogIsOpen(false);
        navigate(`${returnUrlGestionOnusPage}/editar/${gestionOnu.uuid}`);
      },
    });
  };
  ...
  return (
    <SingleTableBoxScene
      ...
      createPageUrl={`${returnUrlGestionOnusPage}/crear`}
      ///* Pendiente a cambio
