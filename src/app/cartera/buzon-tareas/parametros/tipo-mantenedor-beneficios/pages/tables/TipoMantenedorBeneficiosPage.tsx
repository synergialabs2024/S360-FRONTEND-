...
export type TipoMantenedorBeneficiosPageProps = {};
...
> = () => {
  ...
  ///* columns
  const columns = useMemo<MRT_ColumnDef<TipoMantenedorBeneficios>[]>(
    () => [
      {
        accessorKey: 'name',
        header: 'NOMBRE',
  ...
  return (
    ...
    >
      ...
      <CustomTable<TipoMantenedorBeneficios>
        columns={columns}
...
export default TipoMantenedorBeneficiosPage;
