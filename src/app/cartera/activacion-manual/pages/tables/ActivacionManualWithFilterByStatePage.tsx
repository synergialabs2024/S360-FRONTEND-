...
export type ActivacionManualWithFilterByStatePageProps = {
...
const ActivacionManualWithFilterByStatePage: React.FC<
  ActivacionManualWithFilterByStatePageProps
> = () => {
  ...
  const {
    ...
    params: {
      ...
      ...filterObject,
      filterByState: false,
      tipo_suspension: 'MANUAL',
    },
  });

  ///* columns
  const columns = useMemo<MRT_ColumnDef<ActivacionManual>[]>(
    () => [
      {
...
export default ActivacionManualWithFilterByStatePage;
