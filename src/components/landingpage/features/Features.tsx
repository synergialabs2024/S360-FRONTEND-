...
const featuresData: FeaturesType[] = [
  ...
  },
  {
    ...
    subtext:
      'It is JSON Object is used to securely transfer information over the web.',
  },
  {
    icon: <IconArchive width={40} height={40} strokeWidth={1.5} />,
    title: '60+ Page Templates',
    subtext: 'Yes, we have 5 demos & 60+ Pages per demo to make it easier.',
  },
  {
