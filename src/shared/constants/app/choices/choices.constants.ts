...
export enum EstadoOrdenTrabajoEnumChoice {
  ...
  ESPERA_AUDITORIA = 'ESPERA_AUDITORIA', // after upload ot
  ESPERA_ACTUALIZACION_AUDITORIA = 'ESPERA_ACTUALIZACION_AUDITORIA',
  ACTUALIZADO_TECNICO_AUDITORIA = 'ACTUALIZADO_TECNICO_AUDITORIA',
...
export enum EstadoAuditoriaOTInstallEnumChoice {
  ...
  ESPERA_CORRECCION = 'ESPERA_CORRECCION',
