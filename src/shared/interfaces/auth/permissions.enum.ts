export enum PermissionsEnum {
  ...
  administration_view_calendariofacturacion = 'administration.view_calendariofacturacion',
  ...
  administration_view_requestmetainfo = 'administration.view_requestmetainfo',
  ...
  cartera_view_activacioninternet = 'cartera.view_activacioninternet',
  cartera_view_auditlog = 'cartera.view_auditlog',
  cartera_view_beneficiomantenedorbeneficios = 'cartera.view_beneficiomantenedorbeneficios',
  cartera_view_buzontareamantenedor = 'cartera.view_buzontareamantenedor',
  cartera_view_cambiodomicilio = 'cartera.view_cambiodomicilio',
  cartera_view_cambioplan = 'cartera.view_cambioplan',
  cartera_view_causamantenedorbeneficio = 'cartera.view_causamantenedorbeneficio',
  cartera_view_criteriomantenedoractivacion = 'cartera.view_criteriomantenedoractivacion',
  cartera_view_mantenedoractivacion = 'cartera.view_mantenedoractivacion',
  cartera_view_mantenedoractivacionbase = 'cartera.view_mantenedoractivacionbase',
  cartera_view_mantenedorreconexion = 'cartera.view_mantenedorreconexion',
  cartera_view_mantenedorsuspension = 'cartera.view_mantenedorsuspension',
  cartera_view_promesapago = 'cartera.view_promesapago',
  cartera_view_retrynetconnect = 'cartera.view_retrynetconnect',
  cartera_view_solucionmantenedorbeneficio = 'cartera.view_solucionmantenedorbeneficio',
  cartera_view_subtipomantenedorbeneficios = 'cartera.view_subtipomantenedorbeneficios',
  cartera_view_suspensioninternet = 'cartera.view_suspensioninternet',
  cartera_view_tipomantenedorbeneficios = 'cartera.view_tipomantenedorbeneficios',
  ...
  cobranza_view_alquileres = 'cobranza.view_alquileres',
  cobranza_view_clientependientedevolucion = 'cobranza.view_clientependientedevolucion',
  cobranza_view_deudacuotaequiposventa = 'cobranza.view_deudacuotaequiposventa',
  cobranza_view_factura = 'cobranza.view_factura',
  cobranza_view_motivorubroadicional = 'cobranza.view_motivorubroadicional',
  cobranza_view_planpagocuota = 'cobranza.view_planpagocuota',
  cobranza_view_rubro = 'cobranza.view_rubro',
  cobranza_view_rubroalquiler = 'cobranza.view_rubroalquiler',
  cobranza_view_rubroitems = 'cobranza.view_rubroitems',
  ...
  cobranza_view_transaccionpichinchapago = 'cobranza.view_transaccionpichinchapago',
  comercial_view_codigootp = 'comercial.view_codigootp',
  comercial_view_consultaburo = 'comercial.view_consultaburo',
  comercial_view_consultaidentificacion = 'comercial.view_consultaidentificacion',
  ...
  comercial_view_scoremonthlyusageventas = 'comercial.view_scoremonthlyusageventas',
  comercial_view_sistemareferidos = 'comercial.view_sistemareferidos',
  ...
  contabilidad_view_cuentacontable = 'contabilidad.view_cuentacontable',
  ...
  infraestructura_view_brass = 'infraestructura.view_brass',
  ...
  infraestructura_view_napprimary = 'infraestructura.view_napprimary',
  infraestructura_view_nodo = 'infraestructura.view_nodo',
  infraestructura_view_olt = 'infraestructura.view_olt',
  infraestructura_view_ontactionhistory = 'infraestructura.view_ontactionhistory',
  infraestructura_view_ontcontract = 'infraestructura.view_ontcontract',
  infraestructura_view_ontmodel = 'infraestructura.view_ontmodel',
  infraestructura_view_ontunauthorized = 'infraestructura.view_ontunauthorized',
  ...
  infraestructura_view_rutaservice = 'infraestructura.view_rutaservice',
  ...
  inventario_view_modeloinventario = 'inventario.view_modeloinventario',
  inventario_view_motivoegreso = 'inventario.view_motivoegreso',
  inventario_view_motivoingreso = 'inventario.view_motivoingreso',
  inventario_view_motivotransferencia = 'inventario.view_motivotransferencia',
  ...
  inventario_view_solicituddevolicion = 'inventario.view_solicituddevolicion',
  inventario_view_solicitudmaterial = 'inventario.view_solicitudmaterial',
  inventario_view_solicitudtransferenciamaterial = 'inventario.view_solicitudtransferenciamaterial',
  ...
  tecnico_view_causaticketmasivo = 'tecnico.view_causaticketmasivo',
  tecnico_view_departamentoticketmasivo = 'tecnico.view_departamentoticketmasivo',
  tecnico_view_eventomensajeriaticketmasivo = 'tecnico.view_eventomensajeriaticketmasivo',
  tecnico_view_eventoticketmasivo = 'tecnico.view_eventoticketmasivo',
  tecnico_view_incidenciaticketmasivo = 'tecnico.view_incidenciaticketmasivo',
  tecnico_view_mensajeriaticketmasivo = 'tecnico.view_mensajeriaticketmasivo',
  tecnico_view_operadorticketmasivo = 'tecnico.view_operadorticketmasivo',
  tecnico_view_ordentrabajo = 'tecnico.view_ordentrabajo',
  tecnico_view_origenticket = 'tecnico.view_origenticket',
  tecnico_view_prioridadincidenciaticketmasivo = 'tecnico.view_prioridadincidenciaticketmasivo',
  tecnico_view_tickettecnico = 'tecnico.view_tickettecnico',
  televentas_view_leedteleventa = 'televentas.view_leedteleventa',
  ...
  administration_add_calendariofacturacion = 'administration.add_calendariofacturacion',
  ...
  administration_add_requestmetainfo = 'administration.add_requestmetainfo',
  ...
  cartera_add_activacioninternet = 'cartera.add_activacioninternet',
  cartera_add_auditlog = 'cartera.add_auditlog',
  cartera_add_beneficiomantenedorbeneficios = 'cartera.add_beneficiomantenedorbeneficios',
  cartera_add_buzontareamantenedor = 'cartera.add_buzontareamantenedor',
  cartera_add_cambiodomicilio = 'cartera.add_cambiodomicilio',
  cartera_add_cambioplan = 'cartera.add_cambioplan',
  cartera_add_causamantenedorbeneficio = 'cartera.add_causamantenedorbeneficio',
  cartera_add_criteriomantenedoractivacion = 'cartera.add_criteriomantenedoractivacion',
  cartera_add_mantenedoractivacion = 'cartera.add_mantenedoractivacion',
  cartera_add_mantenedoractivacionbase = 'cartera.add_mantenedoractivacionbase',
  cartera_add_mantenedorreconexion = 'cartera.add_mantenedorreconexion',
  cartera_add_mantenedorsuspension = 'cartera.add_mantenedorsuspension',
  cartera_add_promesapago = 'cartera.add_promesapago',
  cartera_add_retrynetconnect = 'cartera.add_retrynetconnect',
  cartera_add_solucionmantenedorbeneficio = 'cartera.add_solucionmantenedorbeneficio',
  cartera_add_subtipomantenedorbeneficios = 'cartera.add_subtipomantenedorbeneficios',
  cartera_add_suspensioninternet = 'cartera.add_suspensioninternet',
  cartera_add_tipomantenedorbeneficios = 'cartera.add_tipomantenedorbeneficios',
  ...
  cobranza_add_alquileres = 'cobranza.add_alquileres',
  cobranza_add_clientependientedevolucion = 'cobranza.add_clientependientedevolucion',
  ...
  cobranza_add_rubroalquiler = 'cobranza.add_rubroalquiler',
  cobranza_add_rubroitems = 'cobranza.add_rubroitems',
  ...
  cobranza_add_transaccionpichinchapago = 'cobranza.add_transaccionpichinchapago',
  comercial_add_codigootp = 'comercial.add_codigootp',
  comercial_add_consultaburo = 'comercial.add_consultaburo',
  comercial_add_consultaidentificacion = 'comercial.add_consultaidentificacion',
  ...
  comercial_add_scoremonthlyusageventas = 'comercial.add_scoremonthlyusageventas',
  comercial_add_sistemareferidos = 'comercial.add_sistemareferidos',
  ...
  comercial_add_solicitudservicioconvenio = 'comercial.add_solicitudservicioconvenio',
  comercial_add_trazabilidadventa = 'comercial.add_trazabilidadventa',
  contabilidad_add_abitmediapagoslog = 'contabilidad.add_abitmediapagoslog',
  contabilidad_add_asientocontable = 'contabilidad.add_asientocontable',
  contabilidad_add_asientocontablelibro = 'contabilidad.add_asientocontablelibro',
  contabilidad_add_cuentacontable = 'contabilidad.add_cuentacontable',
  ...
  infraestructura_add_brass = 'infraestructura.add_brass',
  ...
  infraestructura_add_napprimary = 'infraestructura.add_napprimary',
  infraestructura_add_nodo = 'infraestructura.add_nodo',
  infraestructura_add_olt = 'infraestructura.add_olt',
  infraestructura_add_ontactionhistory = 'infraestructura.add_ontactionhistory',
  infraestructura_add_ontcontract = 'infraestructura.add_ontcontract',
  infraestructura_add_ontmodel = 'infraestructura.add_ontmodel',
  infraestructura_add_ontunauthorized = 'infraestructura.add_ontunauthorized',
  ...
  infraestructura_add_rutaservice = 'infraestructura.add_rutaservice',
  ...
  inventario_add_modeloinventario = 'inventario.add_modeloinventario',
  inventario_add_motivoegreso = 'inventario.add_motivoegreso',
  inventario_add_motivoingreso = 'inventario.add_motivoingreso',
  inventario_add_motivotransferencia = 'inventario.add_motivotransferencia',
  ...
  inventario_add_solicituddevolicion = 'inventario.add_solicituddevolicion',
  inventario_add_solicitudmaterial = 'inventario.add_solicitudmaterial',
  inventario_add_solicitudtransferenciamaterial = 'inventario.add_solicitudtransferenciamaterial',
  ...
  tecnico_add_causaticketmasivo = 'tecnico.add_causaticketmasivo',
  tecnico_add_departamentoticketmasivo = 'tecnico.add_departamentoticketmasivo',
  tecnico_add_eventomensajeriaticketmasivo = 'tecnico.add_eventomensajeriaticketmasivo',
  tecnico_add_eventoticketmasivo = 'tecnico.add_eventoticketmasivo',
  tecnico_add_incidenciaticketmasivo = 'tecnico.add_incidenciaticketmasivo',
  tecnico_add_mensajeriaticketmasivo = 'tecnico.add_mensajeriaticketmasivo',
  tecnico_add_operadorticketmasivo = 'tecnico.add_operadorticketmasivo',
  tecnico_add_ordentrabajo = 'tecnico.add_ordentrabajo',
  tecnico_add_origenticket = 'tecnico.add_origenticket',
  tecnico_add_prioridadincidenciaticketmasivo = 'tecnico.add_prioridadincidenciaticketmasivo',
  tecnico_add_tickettecnico = 'tecnico.add_tickettecnico',
  televentas_add_leedteleventa = 'televentas.add_leedteleventa',
  ...
  administration_change_calendariofacturacion = 'administration.change_calendariofacturacion',
  ...
  administration_change_requestmetainfo = 'administration.change_requestmetainfo',
  ...
  cartera_change_activacioninternet = 'cartera.change_activacioninternet',
  cartera_change_auditlog = 'cartera.change_auditlog',
  cartera_change_beneficiomantenedorbeneficios = 'cartera.change_beneficiomantenedorbeneficios',
  cartera_change_buzontareamantenedor = 'cartera.change_buzontareamantenedor',
  cartera_change_cambiodomicilio = 'cartera.change_cambiodomicilio',
  cartera_change_cambioplan = 'cartera.change_cambioplan',
  cartera_change_causamantenedorbeneficio = 'cartera.change_causamantenedorbeneficio',
  cartera_change_criteriomantenedoractivacion = 'cartera.change_criteriomantenedoractivacion',
  cartera_change_mantenedoractivacion = 'cartera.change_mantenedoractivacion',
  cartera_change_mantenedoractivacionbase = 'cartera.change_mantenedoractivacionbase',
  cartera_change_mantenedorreconexion = 'cartera.change_mantenedorreconexion',
  cartera_change_mantenedorsuspension = 'cartera.change_mantenedorsuspension',
  cartera_change_promesapago = 'cartera.change_promesapago',
  cartera_change_retrynetconnect = 'cartera.change_retrynetconnect',
  cartera_change_solucionmantenedorbeneficio = 'cartera.change_solucionmantenedorbeneficio',
  cartera_change_subtipomantenedorbeneficios = 'cartera.change_subtipomantenedorbeneficios',
  cartera_change_suspensioninternet = 'cartera.change_suspensioninternet',
  cartera_change_tipomantenedorbeneficios = 'cartera.change_tipomantenedorbeneficios',
  ...
  cobranza_change_alquileres = 'cobranza.change_alquileres',
  cobranza_change_clientependientedevolucion = 'cobranza.change_clientependientedevolucion',
  cobranza_change_deudacuotaequiposventa = 'cobranza.change_deudacuotaequiposventa',
  cobranza_change_factura = 'cobranza.change_factura',
  cobranza_change_motivorubroadicional = 'cobranza.change_motivorubroadicional',
  cobranza_change_planpagocuota = 'cobranza.change_planpagocuota',
  cobranza_change_rubro = 'cobranza.change_rubro',
  cobranza_change_rubroalquiler = 'cobranza.change_rubroalquiler',
  cobranza_change_rubroitems = 'cobranza.change_rubroitems',
  ...
  cobranza_change_transaccionpichinchapago = 'cobranza.change_transaccionpichinchapago',
  comercial_change_codigootp = 'comercial.change_codigootp',
  comercial_change_consultaburo = 'comercial.change_consultaburo',
  comercial_change_consultaidentificacion = 'comercial.change_consultaidentificacion',
  ...
  comercial_change_scoremonthlyusageventas = 'comercial.change_scoremonthlyusageventas',
  comercial_change_sistemareferidos = 'comercial.change_sistemareferidos',
  ...
  comercial_change_solicitudservicioconvenio = 'comercial.change_solicitudservicioconvenio',
  comercial_change_trazabilidadventa = 'comercial.change_trazabilidadventa',
  contabilidad_change_abitmediapagoslog = 'contabilidad.change_abitmediapagoslog',
  contabilidad_change_asientocontable = 'contabilidad.change_asientocontable',
  contabilidad_change_asientocontablelibro = 'contabilidad.change_asientocontablelibro',
  contabilidad_change_cuentacontable = 'contabilidad.change_cuentacontable',
  ...
  infraestructura_change_brass = 'infraestructura.change_brass',
  ...
  infraestructura_change_napprimary = 'infraestructura.change_napprimary',
  infraestructura_change_nodo = 'infraestructura.change_nodo',
  infraestructura_change_olt = 'infraestructura.change_olt',
  infraestructura_change_ontactionhistory = 'infraestructura.change_ontactionhistory',
  infraestructura_change_ontcontract = 'infraestructura.change_ontcontract',
  infraestructura_change_ontmodel = 'infraestructura.change_ontmodel',
  infraestructura_change_ontunauthorized = 'infraestructura.change_ontunauthorized',
  ...
  infraestructura_change_rutaservice = 'infraestructura.change_rutaservice',
  ...
  inventario_change_modeloinventario = 'inventario.change_modeloinventario',
  inventario_change_motivoegreso = 'inventario.change_motivoegreso',
  inventario_change_motivoingreso = 'inventario.change_motivoingreso',
  inventario_change_motivotransferencia = 'inventario.change_motivotransferencia',
  ...
  inventario_change_solicituddevolicion = 'inventario.change_solicituddevolicion',
  inventario_change_solicitudmaterial = 'inventario.change_solicitudmaterial',
  inventario_change_solicitudtransferenciamaterial = 'inventario.change_solicitudtransferenciamaterial',
  ...
  tecnico_change_asuntoticket = 'tecnico.change_asuntoticket',
  tecnico_change_causaticketmasivo = 'tecnico.change_causaticketmasivo',
  tecnico_change_departamentoticketmasivo = 'tecnico.change_departamentoticketmasivo',
  tecnico_change_eventomensajeriaticketmasivo = 'tecnico.change_eventomensajeriaticketmasivo',
  tecnico_change_eventoticketmasivo = 'tecnico.change_eventoticketmasivo',
  tecnico_change_incidenciaticketmasivo = 'tecnico.change_incidenciaticketmasivo',
  tecnico_change_mensajeriaticketmasivo = 'tecnico.change_mensajeriaticketmasivo',
  tecnico_change_operadorticketmasivo = 'tecnico.change_operadorticketmasivo',
  tecnico_change_ordentrabajo = 'tecnico.change_ordentrabajo',
  tecnico_change_origenticket = 'tecnico.change_origenticket',
  tecnico_change_prioridadincidenciaticketmasivo = 'tecnico.change_prioridadincidenciaticketmasivo',
  tecnico_change_tickettecnico = 'tecnico.change_tickettecnico',
  televentas_change_leedteleventa = 'televentas.change_leedteleventa',
  ...
  administration_delete_calendariofacturacion = 'administration.delete_calendariofacturacion',
  ...
  administration_delete_requestmetainfo = 'administration.delete_requestmetainfo',
  ...
  cartera_delete_activacioninternet = 'cartera.delete_activacioninternet',
  cartera_delete_auditlog = 'cartera.delete_auditlog',
  cartera_delete_beneficiomantenedorbeneficios = 'cartera.delete_beneficiomantenedorbeneficios',
  cartera_delete_buzontareamantenedor = 'cartera.delete_buzontareamantenedor',
  cartera_delete_cambiodomicilio = 'cartera.delete_cambiodomicilio',
  cartera_delete_cambioplan = 'cartera.delete_cambioplan',
  cartera_delete_causamantenedorbeneficio = 'cartera.delete_causamantenedorbeneficio',
  cartera_delete_criteriomantenedoractivacion = 'cartera.delete_criteriomantenedoractivacion',
  cartera_delete_mantenedoractivacion = 'cartera.delete_mantenedoractivacion',
  cartera_delete_mantenedoractivacionbase = 'cartera.delete_mantenedoractivacionbase',
  cartera_delete_mantenedorreconexion = 'cartera.delete_mantenedorreconexion',
  cartera_delete_mantenedorsuspension = 'cartera.delete_mantenedorsuspension',
  cartera_delete_promesapago = 'cartera.delete_promesapago',
  cartera_delete_retrynetconnect = 'cartera.delete_retrynetconnect',
  cartera_delete_solucionmantenedorbeneficio = 'cartera.delete_solucionmantenedorbeneficio',
  cartera_delete_subtipomantenedorbeneficios = 'cartera.delete_subtipomantenedorbeneficios',
  cartera_delete_suspensioninternet = 'cartera.delete_suspensioninternet',
  cartera_delete_tipomantenedorbeneficios = 'cartera.delete_tipomantenedorbeneficios',
  ...
  cobranza_delete_alquileres = 'cobranza.delete_alquileres',
  cobranza_delete_clientependientedevolucion = 'cobranza.delete_clientependientedevolucion',
  cobranza_delete_deudacuotaequiposventa = 'cobranza.delete_deudacuotaequiposventa',
  cobranza_delete_factura = 'cobranza.delete_factura',
  cobranza_delete_motivorubroadicional = 'cobranza.delete_motivorubroadicional',
  cobranza_delete_planpagocuota = 'cobranza.delete_planpagocuota',
  cobranza_delete_rubro = 'cobranza.delete_rubro',
  cobranza_delete_rubroalquiler = 'cobranza.delete_rubroalquiler',
  cobranza_delete_rubroitems = 'cobranza.delete_rubroitems',
  ...
  cobranza_delete_transaccionpichinchapago = 'cobranza.delete_transaccionpichinchapago',
  comercial_delete_codigootp = 'comercial.delete_codigootp',
  comercial_delete_consultaburo = 'comercial.delete_consultaburo',
  comercial_delete_consultaidentificacion = 'comercial.delete_consultaidentificacion',
  ...
  comercial_delete_scoremonthlyusageventas = 'comercial.delete_scoremonthlyusageventas',
  comercial_delete_sistemareferidos = 'comercial.delete_sistemareferidos',
  ...
  comercial_delete_solicitudservicioconvenio = 'comercial.delete_solicitudservicioconvenio',
  comercial_delete_trazabilidadventa = 'comercial.delete_trazabilidadventa',
  contabilidad_delete_abitmediapagoslog = 'contabilidad.delete_abitmediapagoslog',
  contabilidad_delete_asientocontable = 'contabilidad.delete_asientocontable',
  contabilidad_delete_asientocontablelibro = 'contabilidad.delete_asientocontablelibro',
  contabilidad_delete_cuentacontable = 'contabilidad.delete_cuentacontable',
  ...
  infraestructura_delete_brass = 'infraestructura.delete_brass',
  ...
  infraestructura_delete_napprimary = 'infraestructura.delete_napprimary',
  infraestructura_delete_nodo = 'infraestructura.delete_nodo',
  infraestructura_delete_olt = 'infraestructura.delete_olt',
  infraestructura_delete_ontactionhistory = 'infraestructura.delete_ontactionhistory',
  infraestructura_delete_ontcontract = 'infraestructura.delete_ontcontract',
  infraestructura_delete_ontmodel = 'infraestructura.delete_ontmodel',
  infraestructura_delete_ontunauthorized = 'infraestructura.delete_ontunauthorized',
  ...
  infraestructura_delete_rutaservice = 'infraestructura.delete_rutaservice',
  ...
  inventario_delete_modeloinventario = 'inventario.delete_modeloinventario',
  inventario_delete_motivoegreso = 'inventario.delete_motivoegreso',
  inventario_delete_motivoingreso = 'inventario.delete_motivoingreso',
  inventario_delete_motivotransferencia = 'inventario.delete_motivotransferencia',
  ...
  inventario_delete_solicituddevolicion = 'inventario.delete_solicituddevolicion',
  inventario_delete_solicitudmaterial = 'inventario.delete_solicitudmaterial',
  inventario_delete_solicitudtransferenciamaterial = 'inventario.delete_solicitudtransferenciamaterial',
  ...
  tecnico_delete_asuntoticket = 'tecnico.delete_asuntoticket',
  tecnico_delete_causaticketmasivo = 'tecnico.delete_causaticketmasivo',
  tecnico_delete_departamentoticketmasivo = 'tecnico.delete_departamentoticketmasivo',
  tecnico_delete_eventomensajeriaticketmasivo = 'tecnico.delete_eventomensajeriaticketmasivo',
  tecnico_delete_eventoticketmasivo = 'tecnico.delete_eventoticketmasivo',
  tecnico_delete_incidenciaticketmasivo = 'tecnico.delete_incidenciaticketmasivo',
  tecnico_delete_mensajeriaticketmasivo = 'tecnico.delete_mensajeriaticketmasivo',
  tecnico_delete_operadorticketmasivo = 'tecnico.delete_operadorticketmasivo',
  tecnico_delete_ordentrabajo = 'tecnico.delete_ordentrabajo',
  tecnico_delete_origenticket = 'tecnico.delete_origenticket',
  tecnico_delete_prioridadincidenciaticketmasivo = 'tecnico.delete_prioridadincidenciaticketmasivo',
  tecnico_delete_tickettecnico = 'tecnico.delete_tickettecnico',
  televentas_delete_leedteleventa = 'televentas.delete_leedteleventa',
