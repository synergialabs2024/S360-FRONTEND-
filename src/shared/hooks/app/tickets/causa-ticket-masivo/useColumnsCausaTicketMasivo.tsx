import { useUpdateCausaTicketMasivo } from '@/actions/app';
...
export const useColumnsCausaTicketMasivo = () => {
  ///* global state
  ...
  const changeState = useUpdateCausaTicketMasivo<ChangeModelStateData>({
    enableNavigate: false,
  });

  const causaticketmasivoBaseColumns01 = useMemo<
    MRT_ColumnDef<CausaTicketMasivo>[]
  >(
    () => [
      {
        accessorKey: 'name',
  ...
  const causaticketmasivoColumns = useMemo<MRT_ColumnDef<CausaTicketMasivo>[]>(
    () => [
      ...causaticketmasivoBaseColumns01,
      {
